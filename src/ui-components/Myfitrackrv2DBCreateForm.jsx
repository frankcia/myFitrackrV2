...
export default function Myfitrackrv2DBCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new Myfitrackrv2DB(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "Myfitrackrv2DBCreateForm")}
    >
      <TextField
        label="Count"
        isRequired={true}
